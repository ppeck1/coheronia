...
|---|---|---|---|
| [Basic Pick](equipment/pick_basic.md) | pickaxe | complete | pick_tier=1 |
| [Forged Pick](equipment/pick_forged.md) | pickaxe | complete | pick_tier=2 |
| [Crude Axe](equipment/axe_crude.md) | axe | complete | axe_tier=1 |
...
| Equipment | Slot | Status | Effects |
|---|---|---|---|
| [Crude Helm](equipment/helmet_crude.md) | helmet | complete | armor=1 |
| [Crude Cuirass](equipment/torso_crude.md) | torso | complete | armor=2 |
| [Crude Boots](equipment/feet_crude.md) | feet | complete | armor=1 |
