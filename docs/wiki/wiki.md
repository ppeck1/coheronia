...
| Player gear overlays | `art/generated/player_gear/<item_id>_<body_id>.png` and `<tool_id>_<body_id>_swing_<phase>.png` | 240 body-specific PNGs live (30 crude-armor static + 90 pick/axe swing + 120 sword swing, all four tiers x ten bodies x three phases) | Body-specific -> generic -> rig-aware procedural fallback | Current unresolved ids and intermittent refresh/alignment are tracked on Known Issues. |
...
| `sword_crude` | equipment slot | Yes | `craft_sword` | Early combat weapon | combat progression | complete | optional static held-pose overlay | 30 body/phase swing overlays (S-07.1b); no static held overlay or equipment icon | authored swing frames; procedural held-pose fallback | Direct-equip Town Hall weapon; swing family covers all ten bodies. |
...
| `sword_iron` | equipment slot | Yes | `anvil_iron_sword` | Better combat weapon | combat progression | complete | optional static held-pose overlay | 30 body/phase swing overlays (S-07.1b); no static held overlay or equipment icon | authored swing frames; procedural held-pose fallback | Current best live weapon; swing family covers all ten bodies. |
