...
| Description | Anvil-forged from bronze. Keener than crude, a step below iron. |
| Stat effects | attack_damage=4 |
...
Bronze Sword is a live equipment entry with an active source route and slot effect.

## Acquisition

| Source type | Source | Station | Notes |
|---|---|---|---|
| Recipe equip route | Bronze Sword | [Anvil](../stations/anvil.md) | Equips into `weapon`. |

## Current Use

| Slot | Effects | Notes |
|---|---|---|
| weapon | attack_damage=4 | Live gear effects apply when equipped. |
