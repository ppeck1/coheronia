...
| Description | Anvil-forged bronze plate for the head. |
...
Bronze Helm is a live equipment entry with an active source route and slot effect.

## Acquisition

| Source type | Source | Station | Notes |
|---|---|---|---|
| Recipe equip route | Bronze Armor Set | [Anvil](../stations/anvil.md) | Equips into `helmet`. |

## Current Use

| Slot | Effects | Notes |
|---|---|---|
| helmet | armor=2 | Live gear effects apply when equipped. |
