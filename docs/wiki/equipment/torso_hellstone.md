...
| Description | A breastplate of hellstone bound over iron. The stoutest armor a forge can make. |
| Stat effects | armor=6 |
...
Hellstone Cuirass is a live equipment entry with an active source route and slot effect.

## Acquisition

| Source type | Source | Station | Notes |
|---|---|---|---|
| Recipe equip route | Hellstone Armor Set | [Anvil](../stations/anvil.md) | Equips into `torso`. |

## Current Use

| Slot | Effects | Notes |
|---|---|---|
| torso | armor=6 | Live gear effects apply when equipped. |
