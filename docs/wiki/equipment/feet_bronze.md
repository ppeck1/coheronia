...
| Description | Anvil-forged bronze greaves. |
...
Bronze Boots is a live equipment entry with an active source route and slot effect.

## Acquisition

| Source type | Source | Station | Notes |
|---|---|---|---|
| Recipe equip route | Bronze Armor Set | [Anvil](../stations/anvil.md) | Equips into `feet`. |
