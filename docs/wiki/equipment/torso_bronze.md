...
| Description | Anvil-forged bronze chestplate. |
...
Bronze Cuirass is a live equipment entry with an active source route and slot effect.

## Acquisition

| Source type | Source | Station | Notes |
|---|---|---|---|
| Recipe equip route | Bronze Armor Set | [Anvil](../stations/anvil.md) | Equips into `torso`. |

## Current Use

| Slot | Effects | Notes |
|---|---|---|
| torso | armor=3 | Live gear effects apply when equipped. |
