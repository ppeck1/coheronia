...
| Description | A worked silver band. It hums faintly and deepens attunement. |
| Stat effects | attunement_bonus=5 |
...
Silver Ring is a live equipment entry with an active source route and slot effect.

## Acquisition

| Source type | Source | Station | Notes |
|---|---|---|---|
| Recipe equip route | Silver Ring | [Workbench](../stations/workbench.md) | Equips into `ring_1`. |

## Current Use

| Slot | Effects | Notes |
|---|---|---|
| ring | attunement_bonus=5 | Live gear effects apply when equipped. |
