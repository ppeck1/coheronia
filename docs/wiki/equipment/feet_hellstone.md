...
| Description | Ember-veined hellstone greaves. |
...
Hellstone Boots is a live equipment entry with an active source route and slot effect.

## Acquisition

| Source type | Source | Station | Notes |
|---|---|---|---|
| Recipe equip route | Hellstone Armor Set | [Anvil](../stations/anvil.md) | Equips into `feet`. |

## Current Use

| Slot | Effects | Notes |
|---|---|---|
| feet | armor=3 | Live gear effects apply when equipped. |
