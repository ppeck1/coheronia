...
| Description | Ember-veined plate hammered from hellstone. Runs hot; turns aside nearly any blow. |
| Stat effects | armor=3 |
...
Hellstone Helm is a live equipment entry with an active source route and slot effect.

## Acquisition

| Source type | Source | Station | Notes |
|---|---|---|---|
| Recipe equip route | Hellstone Armor Set | [Anvil](../stations/anvil.md) | Equips into `helmet`. |

## Current Use

| Slot | Effects | Notes |
|---|---|---|
| helmet | armor=3 | Live gear effects apply when equipped. |
