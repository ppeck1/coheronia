...
| Description | Anvil-forged iron chestplate. |
| Stat effects | armor=4 |
...
Iron Cuirass is a live equipment entry with an active source route and slot effect.

## Acquisition

| Source type | Source | Station | Notes |
|---|---|---|---|
| Recipe equip route | Iron Armor Set | [Anvil](../stations/anvil.md) | Equips into `torso`. |

## Current Use

| Slot | Effects | Notes |
|---|---|---|
| torso | armor=4 | Live gear effects apply when equipped. |
