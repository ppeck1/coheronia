...
Oil is a planned item hook. Referenced by planned Lantern Leech drops only.

## Acquisition

| Source type | Source | Quantity / chance | Notes |
|---|---|---|---|
| Enemy drop | [Lantern Leech](../enemies/lantern_leech.md) | 55% drop chance; planned only | Live acquisition only if the enemy is live. |
