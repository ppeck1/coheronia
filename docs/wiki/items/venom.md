...
Venom is a planned item hook. Referenced by planned Ash Wasp drops only.

## Acquisition

| Source type | Source | Quantity / chance | Notes |
|---|---|---|---|
| Enemy drop | [Ash Wasp](../enemies/ash_wasp.md) | 5% drop chance; planned only | Live acquisition only if the enemy is live. |
...
- Recommended first implementation sink: toxin, trap, or advanced craft.
