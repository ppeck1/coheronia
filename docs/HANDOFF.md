...
**v0.1 MVP vertical slice implemented and verified** (run `2026-07-02-mvp-v01-oneshot`, Godot 4.6.1 stable).
...
| Acceptance smoke test | PASS 22/22 | headless and windowed runs, exit 0 |
