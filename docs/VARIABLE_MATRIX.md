...
| Runtime verification (2026-07-21, post PR-06) | Documentation validators, wiki-link check (5,300+ local links), HUD source/runtime hash verification, asset audit, the gear-alignment verifier (`scripts/art/verify_gear_alignment.py`), and the focused inventory smoke (5/5) passed. The full waited-GUI smoke is **343/343**. The arc opened at 332/334 (repaired in PR-00); PR-01/PR-02/PR-03A/PR-03B/PR-04 added the alias, render-contract, gear resolution/alignment, and action-swing checks; PR-05 added `pr05_preview_matches_world_render`; PR-06 added `pr06_character_panel_runtime_render`. The real-time `fq09u1_live_clip_switch` adaptive-music check occasionally cold-flakes and passes on rerun. | Continue the presentation recovery arc from PR-07 (backdrop seam/contour skirt); retain fresh HUD/inventory captures as visual regression proof. |
