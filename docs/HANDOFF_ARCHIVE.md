# Coheronia — Handoff Archive (historical)

_Full historical handoff notes for the pre-Calling arcs (World Depths, Fluids, R-00–R-09, the FQ series, and the Metal Ladder). Kept for provenance only — the **current** state and next steps live in [`HANDOFF.md`](HANDOFF.md). Do NOT treat anything below as current instructions._
