...
| ![The crafting panel opened from the Craft command-tray chip](docs/screenshots/15b_craft_from_button.png)<br>*The centered command tray — **Goal · Craft · Map · Edit** — opens Crafting with a click, no shortcut needed* | ![A raised, torch-lit wooden platform walkway in the world](docs/screenshots/38_wooden_platform.png)<br>*The craftable **Wooden Platform** — a one-way plank you jump up through and walk across* |
