...
def build_sidebar_links(html_path: Path) -> str:
    link_defs = [
        ...
        ("Character Types", WIKI_DIR / "character_types.html", "Species, Callings, traits, and ancestries"),
...
def render_role_page(role: dict) -> None:
    ...
    lines = [
        ...
        "## Summary",
        "",
        f"{role.get('display_name', title_from_id(role['id']))} is a Calling loaded from `data/character_data.json`.",
        "",
        "## Related Pages",
        "",
